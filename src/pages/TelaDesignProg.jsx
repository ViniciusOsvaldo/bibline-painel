...
export default function TelaDesignProg({ usuario }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <h1 className="text-2xl font-bold">Frente Design + Programação</h1>
                      ...
                      <div key={t.id} className="flex items-center justify-between bg-gray-800 rounded-xl px-4 py-3">
                        ...
                        {ehVoce ? (
                          <select
                            ...
                            className="bg-gray-700 border border-gray-600 rounded-lg px-2 py-1 text-xs text-white focus:outline-none focus:border-green-500"
                          >
